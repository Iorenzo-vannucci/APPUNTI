...
class pdp8(object):
    ...
    def colored_AC(self):
        ...
        ac_colored = ""
        for i in range(0, len(self.AC), 4):
            color = colors[(i // 4) % len(colors)]
            ac_colored += color + self.AC[i:i+4]
        return ac_colored + Style.RESET_ALL
    ...
    def __init__(self, codice=None):
        ...
        self.previstr = ""
        self.halt = False
        self.instruction_counter = 0  # Add the instruction counter here
        self.Opcodes = {
    ...
    def _HLT(self):
        ...
        if self.tempo == 0:
            ...
            self.microistruzioni += "----- \n"
        if self.instruction_counter % 4 == 0:
            print("HLT ->", end=' ')
            print("AC:", self.colored_AC(), end=' ')
            print("E:", self.E)
    ...
    def execute(self):
        # Increment and print the instruction counter
        ...
        if self.I == "1" and self.OPR == "111":
            ...
            if self.instruction_counter % 4 == 0:
                instruction_count = self.instruction_counter / 4
                print(f"Istruzione numero: {instruction_count}")
            ...
            self.instruction_counter += 1
            #if isinstance(self.instruction_counter/4, int):
            if self.instruction_counter % 4 == 0:
                instruction_count = self.instruction_counter / 4
                print(f"Istruzione numero: {instruction_count}")
